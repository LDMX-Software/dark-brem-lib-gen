...
c      GAN(2)=dcmplx( ee*Znuc ,Zero) ! add formfactors
      ...
      GEAPX(1)=dcmplx( ee*epsilon ,Zero)
      GEAPX(2)=dcmplx( ee*epsilon ,Zero)
      GUAP(1)=dcmplx( -ee*epsilon*Two/Three ,Zero)
      GUAP(2)=dcmplx( -ee*epsilon*Two/Three ,Zero)
      GDAP(1)=dcmplx( -ee*epsilon/Three ,Zero)
      GDAP(2)=dcmplx( -ee*epsilon/Three ,Zero)
c----------------------------
