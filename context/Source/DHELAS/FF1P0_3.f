...
C     (((mdl_Znuc**2*(mdl_aval**2*(- 2*mdl_MNul**2 -
C      2*P(-1,1)*P(-1,2))/(1+mdl_aval**2*(- 2*mdl_MNul**2 -
C      2*P(-1,1)*P(-1,2))))**2*(1/(1+(- 2*mdl_MNul**2 -
C      2*P(-1,1)*P(-1,2))/mdl_dval))**2)+mdl_Znuc*(mdl_apval**2*(-
C      2*mdl_MNul**2 - 2*P(-1,1)*P(-1,2))/(1+mdl_apval**2*(-
C      2*mdl_MNul**2 - 2*P(-1,1)*P(-1,2))))**2*((1+(- 2*mdl_MNul**2 -
C      2*P(-1,1)*P(-1,2))*mdl_inelastic1)/(1+(- 2*mdl_MNul**2 -
C      2*P(-1,1)*P(-1,2))*mdl_inelastic2)**4)**2)**0.5)*Gamma(3,2,1)
C     
