...
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.6, 2024-09-26
...
C     ----------
     ...
     $    ABS(mdl_Map*small_width_treatment)), mdl_WAp)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_ME,+1,+1*IC(1),W(1,1))  !  count 18
      CALL IXXXXX(P(0,1),MDL_ME,-1,+1*IC(1),W(1,2))  !  count 18
      CALL IXXXXX(P(0,2),MDL_MNUL,+1,+1*IC(2),W(1,3))  !  count 2
      CALL IXXXXX(P(0,2),MDL_MNUL,-1,+1*IC(2),W(1,4))  !  count 2
      CALL OXXXXX(P(0,3),MDL_ME,+1,+1*IC(3),W(1,5))  !  count 18
      CALL OXXXXX(P(0,3),MDL_ME,-1,+1*IC(3),W(1,6))  !  count 18
      CALL OXXXXX(P(0,4),MDL_MNUL,+1,+1*IC(4),W(1,7))  !  count 2
      CALL OXXXXX(P(0,4),MDL_MNUL,-1,+1*IC(4),W(1,8))  !  count 2
      CALL VXXXXX(P(0,5),MDL_MAP,+1,+1*IC(5),W(1,9))  !  count 4
      CALL VXXXXX(P(0,5),MDL_MAP, 0,+1*IC(5),W(1,10))  !  count 4
      CALL VXXXXX(P(0,5),MDL_MAP,-1,+1*IC(5),W(1,11))  !  count 4
      CALL FFV2_4_2(W(1,1),W(1,9),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,12))  !  count 7
      CALL FFV2_4_2(W(1,1),W(1,10),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,13))  !  count 4
      CALL FFV2_4_2(W(1,1),W(1,11),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,14))  !  count 4
      CALL FFV2_4_2(W(1,2),W(1,9),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,15))  !  count 4
      CALL FFV2_4_2(W(1,2),W(1,10),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,16))  !  count 4
      CALL FFV2_4_2(W(1,2),W(1,11),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,17))  !  count 7
      CALL FF1P0_3(W(1,3),W(1,7),GC_87,ZERO,FK_ZERO,W(1,18))  !  count 16
      CALL FF1P0_3(W(1,3),W(1,8),GC_87,ZERO,FK_ZERO,W(1,19))  !  count 14
      CALL FF1P0_3(W(1,4),W(1,7),GC_87,ZERO,FK_ZERO,W(1,20))  !  count 14
      CALL FF1P0_3(W(1,4),W(1,8),GC_87,ZERO,FK_ZERO,W(1,21))  !  count 16
      CALL FFV1P1N_1(W(1,5), W(1,18), GC_4, TMP(1))
      call CombineAmp(4,
     & (/7,6,5,23/), 
     & (/12,13,14,17/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,5), W(1,19), GC_4, TMP(1))
      call CombineAmp(4,
     & (/4,3,2,22/), 
     & (/12,13,14,17/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,5), W(1,20), GC_4, TMP(1))
      call CombineAmp(3,
     & (/15,14,13/), 
     & (/12,13,14/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,5), W(1,21), GC_4, TMP(1))
      call CombineAmp(4,
     & (/12,11,10,30/), 
     & (/12,13,14,17/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,6), W(1,18), GC_4, TMP(1))
      call CombineAmp(4,
     & (/1,21,20,19/), 
     & (/12,15,16,17/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,6), W(1,19), GC_4, TMP(1))
      call CombineAmp(3,
     & (/18,17,16/), 
     & (/15,16,17/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,6), W(1,20), GC_4, TMP(1))
      call CombineAmp(4,
     & (/9,29,28,27/), 
     & (/12,15,16,17/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,6), W(1,21), GC_4, TMP(1))
      call CombineAmp(4,
     & (/8,26,25,24/), 
     & (/12,15,16,17/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_4_1(W(1,5),W(1,9),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,22))  !  count 4
      CALL FFV2_4_1(W(1,5),W(1,10),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,23))  !  count 4
      CALL FFV2_4_1(W(1,5),W(1,11),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,24))  !  count 7
      CALL FFV2_4_1(W(1,6),W(1,9),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,25))  !  count 7
      CALL FFV2_4_1(W(1,6),W(1,10),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,26))  !  count 4
      CALL FFV2_4_1(W(1,6),W(1,11),GC_39,GC_48,MDL_ME,FK_ZERO,W(1,27))  !  count 4
      CALL FFV1P1N_2(W(1,1), W(1,18), GC_4, TMP(1))
      call CombineAmp(4,
     & (/7,6,5,1/), 
     & (/22,23,24,25/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,1), W(1,19), GC_4, TMP(1))
      call CombineAmp(3,
     & (/4,3,2/), 
     & (/22,23,24/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,1), W(1,20), GC_4, TMP(1))
      call CombineAmp(4,
     & (/15,14,13,9/), 
     & (/22,23,24,25/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,1), W(1,21), GC_4, TMP(1))
      call CombineAmp(4,
     & (/12,11,10,8/), 
     & (/22,23,24,25/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,2), W(1,18), GC_4, TMP(1))
      call CombineAmp(4,
     & (/23,21,20,19/), 
     & (/24,25,26,27/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,2), W(1,19), GC_4, TMP(1))
      call CombineAmp(4,
     & (/22,18,17,16/), 
     & (/24,25,26,27/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,2), W(1,20), GC_4, TMP(1))
      call CombineAmp(3,
     & (/29,28,27/), 
     & (/25,26,27/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,2), W(1,21), GC_4, TMP(1))
      call CombineAmp(4,
     & (/30,26,25,24/), 
     & (/24,25,26,27/),
