...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,  23),I=1,5) / 1,-1, 1, 1, 0/
      ...
      DATA (NHEL(I,  32),I=1,5) /-1, 1, 1,-1, 0/
      ...
      DATA (NHEL(I,  41),I=1,5) /-1,-1,-1, 1, 0/
...
C     ----------
     ...
     $    ABS(MDL_MAP*SMALL_WIDTH_TREATMENT)), MDL_WAP)
      ...
      CALL VXXXXX(P(0,5),MDL_MAP,NHEL(5),+1*IC(5),W(1,5))
      CALL FFV2_4_2(W(1,1),W(1,5),GC_39,GC_48,MDL_ME, FK_ZERO,W(1,6))
      CALL FF1P0_3(W(1,2),W(1,4),GC_87,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,3),W(1,7),GC_4,AMP(1))
      CALL FFV2_4_1(W(1,3),W(1,5),GC_39,GC_48,MDL_ME, FK_ZERO,W(1,6))
