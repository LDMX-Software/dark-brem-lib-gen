...
C  
C FOR PROCESS : e- n+ -> e- n+ x  
C  
C Crossing   1 is e- n+ -> e- n+ x  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL VXXXXX(P(0,5   ),APMASS ,NHEL(5   ),+1*IC(5   ),W(1,5   ))      
      CALL JIOXXX(W(1,4   ),W(1,2   ),GAN ,ZERO    ,AWIDTH  ,W(1,6   ))    
      CALL FVIXXX(W(1,1   ),W(1,5   ),GEAP ,ELEMASS ,ZERO    ,W(1,         
     &     7   ))                                                          
      CALL IOVXXX(W(1,7   ),W(1,3   ),W(1,6   ),GAL ,AMP(1   ))            
      CALL FVOXXX(W(1,3   ),W(1,5   ),GEAP ,ELEMASS ,ZERO    ,W(1,         
     &     8   ))                                                          
